          ...
          {route.label ? (
            <div className={`flex flex-1 md:flex-auto`}>
              ...
              >
                ...
                <span className="text-xs sm:text-sm md:text-base">{route.label}</span>
              </Link>
            </div>
          ) : (
            <div className={`flex items-center md:hidden`}>
              <button className="h-10 w-10 flex justify-center items-center bg-primary dark:bg-foreground text-primary-foreground rounded-full">
                <Plus />
              </button>
            </div>
          )}
